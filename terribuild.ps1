...
$product_name = "Steins;Gate Linear Bounded Phenogram Improvement Patch"
...
.\sc3tools\target\release\sc3tools.exe replace-text temp\patched_edited_script_archive\*.SCX sglbp-scripts\*.txt steinsgatelbp
